...
import com.example.llfinalproject.helpers.rememberImeState
import com.example.llfinalproject.helpers.validateRegData
...
fun Onboarding(context: Context, navHostController: NavHostController) {
    ...
    Column(
        ...
        Row(Modifier.fillMaxWidth(0.6f)) {
            Image(painter = painterResource(id = com.example.llfinalproject.R.drawable.logo),
